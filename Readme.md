...
**We are currently looking for contributors in:**

- [ ] **Core Logic:** Optimizing `Span<T>` pipelines.
- [ ] **Cloud:** Vercel Edge & QUIC/UDP implementations.
- [ ] **UI/UX:** Enhancing the Avalonia dashboard.
- [ ] **Integrations:** DAW-specific OSC/MIDI mapping.
